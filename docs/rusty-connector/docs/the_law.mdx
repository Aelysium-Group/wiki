...
:::info Example
If you have a <StaticFamilyTag>survival</StaticFamilyTag> it must only ever contain survival Loaders. It can't contain survival Loaders and also some survival lobby Loaders.
The lobby Loaders must be put in their own family (maybe a <ScalarFamilyTag>survival lobby</ScalarFamilyTag>)
:::
